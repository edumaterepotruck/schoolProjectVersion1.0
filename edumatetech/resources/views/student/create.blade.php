            ...
            @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="admission_date" class="form-control" id="admission_date" placeholder="Enter Admission Date ">
                  @if ($errors->has('admission_date'))
                  <div class="invalid-feedback"  style="color:Tomato;">{{ $errors->first('admission_date') }}</div>
                  @endif
                </div>  
                ...
                <div class="form-group">
                  <label for="registration_no">Admission No</label>
                ...
                <div class="form-group">
                  <label for="gaurdianRelation">gaurdianRelation</label>
