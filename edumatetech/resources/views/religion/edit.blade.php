...
<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Religion Edit</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            @csrf
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" id="name" value="{{ old('name', $religion->name) }}" >
                  @if ($errors->has('name'))
                ...
                <option value="active" {{ old('record_status', $religion->record_status) == "active" ? 'selected' : '' }} >Active</option>
                <option value="inactive" {{ old('record_status', $religion->record_status) == "inactive" ? 'selected' : '' }} >Inactive</option>
                </select>
