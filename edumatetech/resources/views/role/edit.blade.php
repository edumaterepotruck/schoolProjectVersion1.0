...
<div class="box box-primary">
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <option value="active" {{ old('record_status', $role->record_status) == "active" ? 'selected' : '' }} >Active</option>
                <option value="inactive" {{ old('record_status', $role->record_status) == "inactive" ? 'selected' : '' }} >Inactive</option>
                </select>
